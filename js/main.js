...
const translations = {
  ar: {
    ...
    step1_title: "الباقة المجانية",
    step1_desc: "انشاء ملف تعريفي للاعب",
    step2_title: "الباقة الأساسية – 200 ريال / سنوياً",
    step2_desc: "إنشاء ملف لاعب أساسي، الوصول للفرص العامة، خصومات من شركائنا، ومحتوى تعليمي وتطويري.",
    step3_title: "الباقة المتقدمة – 500 ريال / سنوياً",
    step3_desc: "كل ما في الباقة الأساسية، تسويق اللاعب للأندية، الوصول لمدربين ووكلاء، أولوية في المعسكرات، واستشارات تطوير.",
    step4_title: "الباقة الاحترافية – 1000 ريال / سنوياً",
    step4_desc: "إدارة متقدمة لملف اللاعب، فرص تجارب أداء داخل وخارج السعودية، تحليل أداء احترافي + فيديو، دعم بناء الهوية الشخصية، وربط مباشر مع كشافين ووكلاء.",
  ...
  en: {
    ...
    step1_title: "Free Package",
    step1_desc: "Create a player profile.",

    step2_title: "Basic Package – SAR 200 / Yearly",
    step2_desc: "Basic player profile creation, access to public opportunities, partner discounts, and educational and development content.",

    step3_title: "Advanced Package – SAR 500 / Yearly",
    step3_desc: "Everything in the Basic Package, player marketing to clubs, access to coaches and agents, camp priority, and development consultations.",

    step4_title: "Professional Package – SAR 1000 / Yearly",
    step4_desc: "Advanced player profile management, trial opportunities inside and outside Saudi Arabia, professional performance analysis and video services, personal brand support, and direct connections with scouts and agents.",
